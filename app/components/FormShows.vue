        ...
        <form class="row g-3 needs-validation">
          ...
          <div class="col-md-6">
            ...
            <select
              ...
              v-model="details.production_country"
              class="form-select search-input"
